 ...
 * @version
 */
public class Damafon extends MIDlet implements Runnable{
    ...
    private static Damafon instance; 
        
    /**
     * Damafon constructor. starts splashscreen
     */
    public Damafon() {
	instance=this; 
        ...
        s.setProgress("Loading",3); // this message will not be localized  //locale
    ...
    public static Damafon getInstance() {
        return instance;
    }
