...
public class InviteForm implements CommandListener{
    ...
    public InviteForm(Contact contact, Display display) {
        ...
        form=new Form(SR.MS_INVITE); //locale
        reason=new TextField(SR.MS_INVITE_REASON, null, 200, TextField.ANY); //locale
        
        conferenceList=new ChoiceGroup (SR.MS_CONFERENCE, ConstMIDP.CHOICE_POPUP); //locale
