 ...
 * @version
 */
public class BombusSmall extends MIDlet implements Runnable{
    ...
    private static BombusSmall instance; 
        
    /**
     * BombusSmall constructor. starts splashscreen
     */
    public BombusSmall() {
	instance=this; 
	...
	s.setProgress(17);
        ...
        //System.out.println("roster good");        
        if (!selAccount) {
    ...
    public static BombusSmall getInstance() {
        return instance;
    }
