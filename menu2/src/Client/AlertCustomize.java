...
public class AlertCustomize {
    ...
    public void loadOnlineSoundName(){
        if (soundOnlineIndex>=files[0].size()) soundOnlineIndex=0;
    ...
    public void loadOfflineSoundName(){
        if (soundOfflineIndex>=files[0].size()) soundOfflineIndex=0;
    ...
    public void loadForYouSoundName(){
        if (soundForYouIndex>=files[0].size()) soundForYouIndex=0;
    ...
    public void loadComposingSoundName(){
        if (soundComposingIndex>=files[0].size()) soundComposingIndex=0;
    ...
    public void loadConferenceSoundName(){
        if (soundConferenceIndex>=files[0].size()) soundOnlineIndex=0;
